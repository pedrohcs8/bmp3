...
import com.pedrohcs8.bmp3.items.*;
...
public class ModItems {
    ...
    public static final RegistryObject<CustomKeyItem> custom_key = items.register("custom_key", () -> new CustomKeyItem(new Item.Properties().stacksTo(1)));
